...
export const NavBar = ({ current, navTo }) => {
  const navItems = [
    ...
    { id: 'analytics', icon: PieChart, color: '#9CA3AF', activeColor: '#00FFAA', glow: 'rgba(0,255,170,0.6)' },
  ...
  return (
    <div className="absolute bottom-6 w-full px-4 pb-8 z-50 flex justify-center pointer-events-none">
      <div className="relative w-full max-w-[360px] pointer-events-auto">
        ...
        <div className="absolute left-1/2 -top-6 -translate-x-1/2 flex flex-col items-center">
          ...
          >
            ...
            <div className="absolute inset-1 bg-gradient-to-tr from-[#00FFAA]/60 via-[#8B5CF6]/60 to-[#F97316]/50 rounded-full blur-[20px] opacity-70 group-hover:opacity-100 transition-opacity duration-500"></div>
